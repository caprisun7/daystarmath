...
$$5^{x+7} \times 25^{2x-1} \div 125^{2-x}$$
...
Find the value of each of the integers $p$ and $q$ for which 

$$\left(\frac{49}{16}\right)^{-\frac{3}{2}} = 2^p \times 7^q$$.
