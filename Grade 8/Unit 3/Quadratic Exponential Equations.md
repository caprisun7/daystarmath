...
u = \frac{1}{7} \text{ or } u = -3 \text{ (no solution, reject)} \\
...
u = \frac{-2}{5} \text{ (rejected)} \text{ or } u = 2 \\
...
y = 4 \text{ or } y = 8 \\
2^{\frac{x}{2}} = 4 \text{ or } 2^{\frac{x}{2}} = 8 \\
\frac{x}{2} = 2 \text{ or } \frac{x}{2} = 3 \\
